...
public final class EmptySecondOrderSubrule__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x9f283760f9ca4f5bL, 0x8990d42851344ce7L, 0x74abec4a81de956eL, "ProjectionalQiChat.structure.EmptySecondOrderSubrule");

  public static final SMethod<Void> initializeEmptySubSubRule_id7iFV4E1SaQG = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.class)).name("initializeEmptySubSubRule").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("7iFV4E1SaQG").build();

  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(initializeEmptySubSubRule_id7iFV4E1SaQG);

  private static void ___init___(@NotNull SNode __thisNode__) {
    EmptySecondOrderSubrule__BehaviorDescriptor.initializeEmptySubSubRule_id7iFV4E1SaQG.invoke(__thisNode__);
  }

  /*package*/ static void initializeEmptySubSubRule_id7iFV4E1SaQG(@NotNull SNode __thisNode__) {
  ...
  /*package*/ EmptySecondOrderSubrule__BehaviorDescriptor() {
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @Nullable Object[] parameters) {
    ...
    switch (methodIndex) {
      case 0:
        initializeEmptySubSubRule_id7iFV4E1SaQG(node);
        return null;
      default:
        throw new BHMethodNotFoundException(this, method);
    }
