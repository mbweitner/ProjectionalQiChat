...
public class GrammarCellsSubstituteMenu_UserRule extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_UserRule() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_fdomyp_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "UserRule", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_fdomyp_a extends GrammarCellsSubstituteMenuPart {
    @Override
