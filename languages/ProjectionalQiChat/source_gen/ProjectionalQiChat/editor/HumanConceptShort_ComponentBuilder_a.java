...
/*package*/ class HumanConceptShort_ComponentBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public HumanConceptShort_ComponentBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_w2frdc_a");
    if (nodeCondition_w2frdc_a0a()) {
  ...
  private boolean nodeCondition_w2frdc_a0a() {
    return (SLinkOperations.getTarget(myNode, LINKS.comment$PK3S) != null);
  }
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new commentSingleRoleHandler_w2frdc_a0(myNode, LINKS.comment$PK3S, getEditorContext());
    return provider.createCell();
  }
  private static class commentSingleRoleHandler_w2frdc_a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public commentSingleRoleHandler_w2frdc_a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_w2frdc_b0");
    Style style = new StyleImpl();
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      ...
      editorCell.setCellId("HCS_property_name");
      Style style = new StyleImpl();
