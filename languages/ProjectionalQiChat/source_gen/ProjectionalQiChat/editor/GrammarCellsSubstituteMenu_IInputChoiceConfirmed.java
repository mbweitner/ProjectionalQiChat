...
public class GrammarCellsSubstituteMenu_IInputChoiceConfirmed extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_IInputChoiceConfirmed() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_an6fb4_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "IInputChoiceConfirmed", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_an6fb4_a extends GrammarCellsSubstituteMenuPart {
    @Override
