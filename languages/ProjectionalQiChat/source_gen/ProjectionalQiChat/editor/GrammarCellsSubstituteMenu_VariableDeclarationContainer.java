...
public class GrammarCellsSubstituteMenu_VariableDeclarationContainer extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_VariableDeclarationContainer() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_k65qlr_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "VariableDeclarationContainer", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_k65qlr_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.VariableDeclarationContainer$Zf;
    }
  }
