...
public class AbstractEvent_KeyMap extends KeyMapImpl {
  public AbstractEvent_KeyMap() {
    this.setApplicableToEveryModel(false);
    KeyMapAction action;
    action = new AbstractEvent_KeyMap_Action0();
    this.putAction("any", " ", action);
    this.putAction("any", "letter or digit", action);
  }
  public static class AbstractEvent_KeyMap_Action0 extends KeyMapActionImpl {
    public AbstractEvent_KeyMap_Action0() {
    ...
    public boolean canExecute(final EditorContext editorContext) {
      ...
      if (!(SNodeOperations.isInstanceOf(contextNode, CONCEPTS.AbstractEvent$sH))) {
        return false;
      }
      return true;
    }
