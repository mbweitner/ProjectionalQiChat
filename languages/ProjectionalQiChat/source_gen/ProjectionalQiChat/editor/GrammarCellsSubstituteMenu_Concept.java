...
public class GrammarCellsSubstituteMenu_Concept extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Concept() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_2pb4km_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Concept", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_2pb4km_a extends GrammarCellsSubstituteMenuPart {
    @Override
