...
public class Optional_KeyMap extends KeyMapImpl {
  public Optional_KeyMap() {
    this.setApplicableToEveryModel(false);
    KeyMapAction action;
    action = new Optional_KeyMap_Action0();
    this.putAction("any", " ", action);
    action = new Optional_KeyMap_Action1();
    this.putAction("any", " ", action);
    this.putAction("any", "}", action);
  }
  public static class Optional_KeyMap_Action0 extends KeyMapActionImpl {
    public Optional_KeyMap_Action0() {
    ...
    public boolean canExecute(final EditorContext editorContext) {
      ...
      if (!(SNodeOperations.isInstanceOf(contextNode, CONCEPTS.Optional$1D))) {
        return false;
      }
      return true;
    }
  ...
  public static class Optional_KeyMap_Action1 extends KeyMapActionImpl {
    public Optional_KeyMap_Action1() {
