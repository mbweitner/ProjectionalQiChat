...
public class GrammarCellsSubstituteMenu_Rule extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Rule() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_8ha51o_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Rule", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_8ha51o_a extends GrammarCellsSubstituteMenuPart {
    @Override
