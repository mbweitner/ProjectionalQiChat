...
public class GrammarCellsSubstituteMenu_Number extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Number() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_fc7i5u_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Number", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_fc7i5u_a extends GrammarCellsSubstituteMenuPart {
    @Override
