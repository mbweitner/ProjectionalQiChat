...
public class GrammarCellsSubstituteMenu_AbstractUserRule extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_AbstractUserRule() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_2qrt5u_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "AbstractUserRule", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_2qrt5u_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.AbstractUserRule$nO;
    }
  }
