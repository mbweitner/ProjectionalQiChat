...
public class InputStore_KeyMap extends KeyMapImpl {
  public InputStore_KeyMap() {
    this.setApplicableToEveryModel(false);
    KeyMapAction action;
    action = new InputStore_KeyMap_Action0();
    this.putAction("any", " ", action);
    this.putAction("any", "letter or digit", action);
  }
  public static class InputStore_KeyMap_Action0 extends KeyMapActionImpl {
    public InputStore_KeyMap_Action0() {
    ...
    public boolean canExecute(final EditorContext editorContext) {
      ...
      if (!(SNodeOperations.isInstanceOf(contextNode, CONCEPTS.InputStore$rg))) {
        return false;
      }
      return true;
    }
