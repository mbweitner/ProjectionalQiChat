...
public class GrammarCellsSubstituteMenu_InputChoice extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_InputChoice() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_n557sn_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "InputChoice", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_n557sn_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.InputChoice$KG;
    }
  }
