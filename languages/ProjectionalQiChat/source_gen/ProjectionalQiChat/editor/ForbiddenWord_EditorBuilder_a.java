...
/*package*/ class ForbiddenWord_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ForbiddenWord_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_evdnj8_a0");
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.word$nPON;
  ...
  private EditorCell createEmpty_0() {
    ...
    editorCell.setCellId("Empty_evdnj8_c0");
    return editorCell;
  }
