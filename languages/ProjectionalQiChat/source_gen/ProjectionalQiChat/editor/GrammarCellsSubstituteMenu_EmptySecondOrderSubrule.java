...
public class GrammarCellsSubstituteMenu_EmptySecondOrderSubrule extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EmptySecondOrderSubrule() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_b70umx_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EmptySecondOrderSubrule", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_b70umx_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.EmptySecondOrderSubrule$op;
    }
  }
