...
public class GrammarCellsSubstituteMenu_Word extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Word() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_8hbocz_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Word", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_8hbocz_a extends GrammarCellsSubstituteMenuPart {
    @Override
