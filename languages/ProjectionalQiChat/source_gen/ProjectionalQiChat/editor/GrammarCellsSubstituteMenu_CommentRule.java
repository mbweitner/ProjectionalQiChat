...
public class GrammarCellsSubstituteMenu_CommentRule extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_CommentRule() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_bfjijz_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "CommentRule", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_bfjijz_a extends GrammarCellsSubstituteMenuPart {
    @Override
