...
public class GrammarCellsSubstituteMenu_VariableDeclaration extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_VariableDeclaration() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_mf0cpt_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "VariableDeclaration", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_mf0cpt_a extends GrammarCellsSubstituteMenuPart {
    @Override
