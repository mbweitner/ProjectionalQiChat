...
public class GrammarCellsSubstituteMenu_NextProposal extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_NextProposal() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_bfjxg0_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "NextProposal", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_bfjxg0_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.NextProposal$AA;
    }
  }
