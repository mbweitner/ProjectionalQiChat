...
public class GrammarCellsSubstituteMenu_Topic extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Topic() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_eac2q1_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Topic", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_eac2q1_a extends GrammarCellsSubstituteMenuPart {
    @Override
