...
public class GrammarCellsSubstituteMenu_Proposal extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Proposal() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_9dgwzr_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Proposal", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_9dgwzr_a extends GrammarCellsSubstituteMenuPart {
    @Override
