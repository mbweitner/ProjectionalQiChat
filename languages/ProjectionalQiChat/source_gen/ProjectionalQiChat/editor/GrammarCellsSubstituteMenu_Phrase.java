...
public class GrammarCellsSubstituteMenu_Phrase extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Phrase() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_fpq1yi_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Phrase", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_fpq1yi_a extends GrammarCellsSubstituteMenuPart {
    @Override
