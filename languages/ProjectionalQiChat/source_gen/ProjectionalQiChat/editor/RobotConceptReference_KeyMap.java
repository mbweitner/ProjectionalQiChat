...
public class RobotConceptReference_KeyMap extends KeyMapImpl {
  public RobotConceptReference_KeyMap() {
    this.setApplicableToEveryModel(false);
    KeyMapAction action;
    action = new RobotConceptReference_KeyMap_Action0();
    this.putAction("any", " ", action);
    this.putAction("any", "letter or digit", action);
  }
  public static class RobotConceptReference_KeyMap_Action0 extends KeyMapActionImpl {
    public RobotConceptReference_KeyMap_Action0() {
    ...
    public boolean canExecute(final EditorContext editorContext) {
      ...
      if (!(SNodeOperations.isInstanceOf(contextNode, CONCEPTS.RobotConceptReference$r0))) {
        return false;
      }
      return true;
    }
