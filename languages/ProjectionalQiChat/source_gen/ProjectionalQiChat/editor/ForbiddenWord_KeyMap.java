...
public class ForbiddenWord_KeyMap extends KeyMapImpl {
  public ForbiddenWord_KeyMap() {
    this.setApplicableToEveryModel(false);
    KeyMapAction action;
    action = new ForbiddenWord_KeyMap_Action0();
    this.putAction("any", " ", action);
    action = new ForbiddenWord_KeyMap_Action1();
    this.putAction("any", " ", action);
  }
  public static class ForbiddenWord_KeyMap_Action0 extends KeyMapActionImpl {
    public ForbiddenWord_KeyMap_Action0() {
    ...
    public boolean canExecute(final EditorContext editorContext) {
      ...
      if (!(SNodeOperations.isInstanceOf(contextNode, CONCEPTS.ForbiddenWord$rJ))) {
        return false;
      }
      return true;
    }
  ...
  public static class ForbiddenWord_KeyMap_Action1 extends KeyMapActionImpl {
    public ForbiddenWord_KeyMap_Action1() {
  ...
  private static final class CONCEPTS {
    /*package*/ static final SConcept ForbiddenWord$rJ = MetaAdapterFactory.getConcept(0x9f283760f9ca4f5bL, 0x8990d42851344ce7L, 0x6fd223061c49b15eL, "ProjectionalQiChat.structure.ForbiddenWord");
  }
