...
/*package*/ class RobotConcept_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new ruleSingleRoleHandler_cmeql3_a2a(myNode, LINKS.rule$l80a, getEditorContext());
    return provider.createCell();
  }
  private static class ruleSingleRoleHandler_cmeql3_a2a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public ruleSingleRoleHandler_cmeql3_a2a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
