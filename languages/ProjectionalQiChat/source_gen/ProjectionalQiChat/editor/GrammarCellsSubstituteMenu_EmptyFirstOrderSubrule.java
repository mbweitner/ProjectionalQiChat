...
public class GrammarCellsSubstituteMenu_EmptyFirstOrderSubrule extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EmptyFirstOrderSubrule() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_r3s68m_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EmptyFirstOrderSubrule", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_r3s68m_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.EmptyFirstOrderSubrule$mT;
    }
  }
