...
public class GrammarCellsSubstituteMenu_CustomEvent extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_CustomEvent() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_enmxdy_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "CustomEvent", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_enmxdy_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.CustomEvent$Ti;
    }
  }
