...
public class GrammarCellsSubstituteMenu_StringValue extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_StringValue() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_gznzxe_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "StringValue", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_gznzxe_a extends GrammarCellsSubstituteMenuPart {
    @Override
