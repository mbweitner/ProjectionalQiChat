...
public class GrammarCellsSubstituteMenu_AbstractEvent extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_AbstractEvent() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_73kz5q_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "AbstractEvent", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_73kz5q_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.AbstractEvent$sH;
    }
  }
