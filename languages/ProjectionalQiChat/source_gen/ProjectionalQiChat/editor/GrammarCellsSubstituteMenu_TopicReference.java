...
public class GrammarCellsSubstituteMenu_TopicReference extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_TopicReference() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_pd7mnw_a());
    return result;
  }
  ...
  private class GrammarCellsSubstituteMenuPart_pd7mnw_a extends GrammarCellsSubstituteMenuPart {
    @Override
