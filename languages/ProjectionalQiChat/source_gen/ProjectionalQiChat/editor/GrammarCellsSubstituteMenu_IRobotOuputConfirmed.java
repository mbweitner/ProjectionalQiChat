...
public class GrammarCellsSubstituteMenu_IRobotOuputConfirmed extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_IRobotOuputConfirmed() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_7etz7d_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "IRobotOuputConfirmed", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_7etz7d_a extends GrammarCellsSubstituteMenuPart {
    @Override
