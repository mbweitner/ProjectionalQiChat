...
public class GrammarCellsSubstituteMenu_InputStore extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_InputStore() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_4b41bd_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "InputStore", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_4b41bd_a extends GrammarCellsSubstituteMenuPart {
    @Override
