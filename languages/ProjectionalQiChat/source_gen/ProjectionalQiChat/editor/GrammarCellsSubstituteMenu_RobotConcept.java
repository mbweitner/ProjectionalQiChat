...
public class GrammarCellsSubstituteMenu_RobotConcept extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_RobotConcept() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_9e9gil_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "RobotConcept", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_9e9gil_a extends GrammarCellsSubstituteMenuPart {
    @Override
