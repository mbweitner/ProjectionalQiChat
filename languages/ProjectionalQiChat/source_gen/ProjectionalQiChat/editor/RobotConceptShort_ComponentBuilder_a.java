...
/*package*/ class RobotConceptShort_ComponentBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public RobotConceptShort_ComponentBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_u4gjzj_a");
    if (nodeCondition_u4gjzj_a0a()) {
  ...
  private boolean nodeCondition_u4gjzj_a0a() {
    return (SLinkOperations.getTarget(myNode, LINKS.comment$PK3S) != null);
  }
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new commentSingleRoleHandler_u4gjzj_a0(myNode, LINKS.comment$PK3S, getEditorContext());
    return provider.createCell();
  }
  private static class commentSingleRoleHandler_u4gjzj_a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public commentSingleRoleHandler_u4gjzj_a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_u4gjzj_b0");
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      ...
      editorCell.setCellId("RCS_property_name");
      Style style = new StyleImpl();
