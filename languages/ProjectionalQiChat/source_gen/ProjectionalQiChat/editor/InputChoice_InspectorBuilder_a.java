...
/*package*/ class InputChoice_InspectorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new choicesListHandler_jkr9kg_b0(myNode, getEditorContext());
  ...
  private static class choicesListHandler_jkr9kg_b0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public choicesListHandler_jkr9kg_b0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(choicesListHandler_jkr9kg_b0.this.getNode(), LINKS.choices$YXnx));
      try {
