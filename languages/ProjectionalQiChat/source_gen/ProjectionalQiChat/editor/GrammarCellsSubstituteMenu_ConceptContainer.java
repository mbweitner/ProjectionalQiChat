...
public class GrammarCellsSubstituteMenu_ConceptContainer extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ConceptContainer() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_xgxbey_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ConceptContainer", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_xgxbey_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.ConceptContainer$NA;
    }
  }
