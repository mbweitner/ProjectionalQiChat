...
public class EditorAspectDescriptorImpl extends EditorAspectDescriptorBase implements EditorHintsProvider {
  ...
  public Collection<KeyMap> getDeclaredKeyMaps() {
    return Arrays.<KeyMap>asList(new Word_KeyMap(), new ForbiddenWord_KeyMap(), new Optional_KeyMap(), new Wildcard_KeyMap(), new OutputChoice__KeyMap(), new InputChoice_KeyMap(), new Pause_KeyMap(), new Phrase_KeyMap(), new Function_KeyMap(), new AbstractEvent_KeyMap(), new InputStore_KeyMap(), new RobotConceptReference_KeyMap(), new HumanConcept_KeyMap(), new RobotConcept_KeyMap());
  }
