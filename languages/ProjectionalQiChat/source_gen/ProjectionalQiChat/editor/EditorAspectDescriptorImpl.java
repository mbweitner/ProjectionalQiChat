...
public class EditorAspectDescriptorImpl extends EditorAspectDescriptorBase implements EditorHintsProvider {
  ...
  public Collection<ConceptEditor> getDeclaredEditors(SAbstractConcept concept) {
    ...
    switch (conceptIndex.index(cncpt)) {
      ...
      case 49:
        return Collections.<ConceptEditor>singletonList(new onStartEvent_Editor());
      default:
    }
  ...
  private Collection<ConceptEditorComponent> getDeclaredEC_4(String editorComponentId) {
    if ("ProjectionalQiChat.editor.explanation".equals(editorComponentId)) {
      return Collections.singletonList(new explanation());
    }
    return Collections.emptyList();
  }
  ...
  public Collection<SubstituteMenu> getDeclaredDefaultSubstituteMenus(SAbstractConcept concept) {
    ...
    switch (conceptIndex3.index(cncpt)) {
      ...
      case 74:
        return Collections.<SubstituteMenu>singletonList(new GrammarCellsSubstituteMenu_onStartEvent());
      default:
    }
