...
public class GrammarCellsSubstituteMenu_ThirdOrderSubrule extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ThirdOrderSubrule() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_fa6svw_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ThirdOrderSubrule", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_fa6svw_a extends GrammarCellsSubstituteMenuPart {
    @Override
