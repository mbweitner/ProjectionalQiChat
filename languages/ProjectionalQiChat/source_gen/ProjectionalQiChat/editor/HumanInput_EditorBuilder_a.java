...
/*package*/ class HumanInput_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  public HumanInput_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_3j2vfr_a");
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new inputsListHandler_3j2vfr_a0(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Horizontal(), false);
    editorCell.setCellId("refNodeList_inputs");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class inputsListHandler_3j2vfr_a0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public inputsListHandler_3j2vfr_a0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SContainmentLink getSLink() {
      return LINKS.inputs$iwW4;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.IHumanInputConfirmed$rG;
    }
    ...
    private EditorCell createCollection_1() {
      ...
      editorCell.setCellId("Collection_3j2vfr_a0a");
    ...
    private EditorCell createConstant_0() {
      ...
      editorCell.setCellId("Constant_3j2vfr_a0a0");
      editorCell.setDefaultText("");
      return editorCell;
    }
    private EditorCell createConstant_1() {
      EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
      editorCell.setCellId("Constant_3j2vfr_b0a0");
