...
/*package*/ class UserRule_InspectorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new commentSingleRoleHandler_stapb6_c0(myNode, LINKS.comment$qgE6, getEditorContext());
    return provider.createCell();
  }
  private static class commentSingleRoleHandler_stapb6_c0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public commentSingleRoleHandler_stapb6_c0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new subrulesListHandler_stapb6_e0(myNode, getEditorContext());
  ...
  private static class subrulesListHandler_stapb6_e0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public subrulesListHandler_stapb6_e0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(subrulesListHandler_stapb6_e0.this.getNode(), LINKS.subrules$kZhF));
      try {
    ...
    public EditorCell createSeparatorCell(SNode prevNode, SNode nextNode) {
      EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), getNode(), subrulesListHandler_stapb6_e0.this.getSeparatorText(prevNode, nextNode));
  ...
  private EditorCell createConstant_6() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "Rule which human input the robot should recognize and what should be the robot output in response.");
  ...
  private EditorCell createConstant_7() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
    editorCell.setCellId("Constant_stapb6_7");
    Style style = new StyleImpl();
    new notEditableStyleClass(getEditorContext(), getNode()).apply(style, editorCell);
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
  ...
  private EditorCell createConstant_8() {
    ...
    editorCell.setCellId("Constant_stapb6_8");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createConstant_9() {
    ...
    editorCell.setCellId("Constant_stapb6_9");
    editorCell.setDefaultText("");
    return editorCell;
  }
