...
/*package*/ class SecondOrderSubrule_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_2() {
    SingleRoleCellProvider provider = new outputSingleRoleHandler_hnx045_e1a(myNode, LINKS.output$kSeI, getEditorContext());
    return provider.createCell();
  }
  private static class outputSingleRoleHandler_hnx045_e1a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public outputSingleRoleHandler_hnx045_e1a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
  ...
  private EditorCell createCollection_2() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_hnx045_f1a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new subrulesListHandler_hnx045_a5b0(myNode, getEditorContext());
  ...
  private static class subrulesListHandler_hnx045_a5b0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public subrulesListHandler_hnx045_a5b0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SNode nodeFactory(SNode prevNode, SNode nextNode, int index) {
      SNode newSub = SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0x9f283760f9ca4f5bL, 0x8990d42851344ce7L, 0x6fd223061c49b105L, "ProjectionalQiChat.structure.ThirdOrderSubrule"));
      SNode emptySubrule = SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0x9f283760f9ca4f5bL, 0x8990d42851344ce7L, 0x74abec4a81de9592L, "ProjectionalQiChat.structure.EmptyThirdOrderSubrule"));
      EmptyThirdOrderSubrule__BehaviorDescriptor.initializeEmptySubSubSubRule_id7iFV4E1Syz8.invoke(emptySubrule);
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(subrulesListHandler_hnx045_a5b0.this.getNode(), LINKS.subrules$l0eH));
      try {
