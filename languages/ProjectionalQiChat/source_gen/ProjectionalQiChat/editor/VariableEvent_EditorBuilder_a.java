...
/*package*/ class VariableEvent_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.variable$lkCa;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.variable$lkCa);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.variable$lkCa);
    }
  ...
  private EditorCell createConstant_1() {
    ...
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_LEFT, _StyleParameter_QueryFunction_l1iqiv_a0b0());
    editorCell.getStyle().putAll(style);
    editorCell.addKeyMap(new AbstractEvent_KeyMap());
    editorCell.setDefaultText("");
    return editorCell;
  }
  private boolean _StyleParameter_QueryFunction_l1iqiv_a0b0() {
