...
public class GrammarCellsSubstituteMenu_ConceptCollectionReference extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ConceptCollectionReference() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_uxja0g_a());
    return result;
  }
  ...
  private class GrammarCellsSubstituteMenuPart_uxja0g_a extends GrammarCellsSubstituteMenuPart {
    @Override
