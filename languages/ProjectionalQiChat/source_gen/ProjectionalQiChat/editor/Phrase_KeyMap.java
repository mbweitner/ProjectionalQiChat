...
public class Phrase_KeyMap extends KeyMapImpl {
  public Phrase_KeyMap() {
    this.setApplicableToEveryModel(false);
    KeyMapAction action;
    action = new Phrase_KeyMap_Action0();
    this.putAction("any", "letter or digit", action);
    this.putAction("any", " ", action);
  }
  public static class Phrase_KeyMap_Action0 extends KeyMapActionImpl {
    public Phrase_KeyMap_Action0() {
    ...
    public boolean canExecute(final EditorContext editorContext) {
      ...
      if (!(SNodeOperations.isInstanceOf(contextNode, CONCEPTS.Phrase$1a))) {
        return false;
      }
      return true;
    }
