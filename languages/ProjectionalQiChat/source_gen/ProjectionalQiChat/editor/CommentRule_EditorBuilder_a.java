...
/*package*/ class CommentRule_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  public CommentRule_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_s67ebc_a");
  ...
  private static class commentSingleRoleHandler_s67ebc_a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public commentSingleRoleHandler_s67ebc_a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
