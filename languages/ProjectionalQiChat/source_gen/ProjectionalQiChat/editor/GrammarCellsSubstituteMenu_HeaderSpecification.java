...
public class GrammarCellsSubstituteMenu_HeaderSpecification extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_HeaderSpecification() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_4mowvh_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "HeaderSpecification", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_4mowvh_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.HeaderSpecification$c2;
    }
  }
