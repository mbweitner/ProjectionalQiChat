...
/*package*/ class HumanConcept_modelling_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public HumanConcept_modelling_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createDiagramNode_0(final EditorContext editorContext, final SNode node) {
    ...
    ContextVariables.withValue("thisNode", node, () -> {
      ...
      editorCell.value.setCellId("DiagramNode_y30zl4_a");
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_y30zl4_a0");
    if (nodeCondition_y30zl4_a0a0()) {
      editorCell.addEditorCell(createCollection_1());
    }
    if (nodeCondition_y30zl4_a1a0()) {
      editorCell.addEditorCell(createComponent_1());
    }
    return editorCell;
  }
  private boolean nodeCondition_y30zl4_a0a0() {
  ...
  private boolean nodeCondition_y30zl4_a1a0() {
    if (SNodeOperations.isInstanceOf(SNodeOperations.getParent(myNode), CONCEPTS.HeaderSpecification$c2)) {
      return !(SPropertyOperations.getBoolean(SNodeOperations.as(SNodeOperations.getParent(myNode), CONCEPTS.HeaderSpecification$c2), PROPS.showDetails$iMOJ)) && !(getEditorContext().isInspector());
    } else {
      return false;
  ...
  private EditorCell createCollection_1() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Vertical());
    editorCell.setCellId("Collection_y30zl4_a0a");
    if (nodeCondition_y30zl4_a0a0a()) {
      editorCell.addEditorCell(createRefNode_0());
    }
    editorCell.addEditorCell(createComponent_0());
    return editorCell;
  }
  private boolean nodeCondition_y30zl4_a0a0a() {
    return (SLinkOperations.getTarget(myNode, LINKS.comment$PK3S) != null);
  }
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new commentSingleRoleHandler_y30zl4_a0a0(myNode, LINKS.comment$PK3S, getEditorContext());
    return provider.createCell();
  }
  private static class commentSingleRoleHandler_y30zl4_a0a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public commentSingleRoleHandler_y30zl4_a0a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createComponent_0() {
    EditorCell editorCell = getCellFactory().createEditorComponentCell(myNode, "ProjectionalQiChat.editor.HumanConcept");
    return editorCell;
  }
  private EditorCell createComponent_1() {
    EditorCell editorCell = getCellFactory().createEditorComponentCell(myNode, "ProjectionalQiChat.editor.HumanConceptShort");
    return editorCell;
  }
