...
public class GrammarCellsSubstituteMenu_HumanInput extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_HumanInput() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_tfvwbg_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "HumanInput", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_tfvwbg_a extends GrammarCellsSubstituteMenuPart {
    @Override
