...
public class new_secondOrderSubrule extends KeyMapImpl {
  public new_secondOrderSubrule() {
    this.setApplicableToEveryModel(false);
    KeyMapAction action;
    action = new new_secondOrderSubrule_Action0();
    this.putAction("any", " ", action);
  }
  public static class new_secondOrderSubrule_Action0 extends KeyMapActionImpl {
    public new_secondOrderSubrule_Action0() {
    ...
    public boolean canExecute(final EditorContext editorContext) {
      ...
      if (!(SNodeOperations.isInstanceOf(contextNode, CONCEPTS.FirstOrderSubrule$oM))) {
        return false;
      }
      return true;
    }
    ...
    private void execute_internal(final EditorContext editorContext, final SNode node, final List<SNode> selectedNodes) {
      SNodeFactoryOperations.addNewChild(node, LINKS.subrules$kZKc, CONCEPTS.SecondOrderSubrule$ph);
    }
