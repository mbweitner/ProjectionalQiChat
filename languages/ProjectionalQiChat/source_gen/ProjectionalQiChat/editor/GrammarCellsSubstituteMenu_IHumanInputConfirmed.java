...
public class GrammarCellsSubstituteMenu_IHumanInputConfirmed extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_IHumanInputConfirmed() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_z6iil6_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "IHumanInputConfirmed", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_z6iil6_a extends GrammarCellsSubstituteMenuPart {
    @Override
