...
public class InputChoice_KeyMap extends KeyMapImpl {
  public InputChoice_KeyMap() {
    this.setApplicableToEveryModel(false);
    KeyMapAction action;
    action = new InputChoice_KeyMap_Action0();
    this.putAction("any", "letter or digit", action);
    this.putAction("any", " ", action);
  }
  public static class InputChoice_KeyMap_Action0 extends KeyMapActionImpl {
    public InputChoice_KeyMap_Action0() {
    ...
    public boolean canExecute(final EditorContext editorContext) {
      ...
      if (!(SNodeOperations.isInstanceOf(contextNode, CONCEPTS.InputChoice$KG))) {
        return false;
      }
      return true;
    }
