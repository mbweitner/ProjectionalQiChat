...
public class Pause_KeyMap extends KeyMapImpl {
  public Pause_KeyMap() {
    this.setApplicableToEveryModel(false);
    KeyMapAction action;
    action = new Pause_KeyMap_Action0();
    this.putAction("any", "letter or digit", action);
    this.putAction("any", " ", action);
  }
  public static class Pause_KeyMap_Action0 extends KeyMapActionImpl {
    public Pause_KeyMap_Action0() {
    ...
    public boolean canExecute(final EditorContext editorContext) {
      ...
      if (!(SNodeOperations.isInstanceOf(contextNode, CONCEPTS.Pause$uM))) {
        return false;
      }
      return true;
    }
