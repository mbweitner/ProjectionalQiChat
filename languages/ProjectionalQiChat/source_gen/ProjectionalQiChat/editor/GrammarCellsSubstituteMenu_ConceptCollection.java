...
public class GrammarCellsSubstituteMenu_ConceptCollection extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ConceptCollection() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_rjibph_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ConceptCollection", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_rjibph_a extends GrammarCellsSubstituteMenuPart {
    @Override
