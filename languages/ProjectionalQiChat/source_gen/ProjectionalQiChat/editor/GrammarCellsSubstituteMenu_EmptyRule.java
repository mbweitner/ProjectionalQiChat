...
public class GrammarCellsSubstituteMenu_EmptyRule extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EmptyRule() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_mr2na_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EmptyRule", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_mr2na_a extends GrammarCellsSubstituteMenuPart {
    @Override
