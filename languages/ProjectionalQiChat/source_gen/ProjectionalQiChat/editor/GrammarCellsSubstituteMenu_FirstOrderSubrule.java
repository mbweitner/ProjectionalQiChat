...
public class GrammarCellsSubstituteMenu_FirstOrderSubrule extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_FirstOrderSubrule() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_u4tyu9_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "FirstOrderSubrule", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_u4tyu9_a extends GrammarCellsSubstituteMenuPart {
    @Override
