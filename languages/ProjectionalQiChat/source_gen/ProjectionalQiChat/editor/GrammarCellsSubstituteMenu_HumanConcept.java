...
public class GrammarCellsSubstituteMenu_HumanConcept extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_HumanConcept() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_egu7kb_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "HumanConcept", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_egu7kb_a extends GrammarCellsSubstituteMenuPart {
    @Override
