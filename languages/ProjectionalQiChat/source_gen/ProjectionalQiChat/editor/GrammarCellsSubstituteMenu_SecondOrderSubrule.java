...
public class GrammarCellsSubstituteMenu_SecondOrderSubrule extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_SecondOrderSubrule() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_y2gfa7_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "SecondOrderSubrule", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_y2gfa7_a extends GrammarCellsSubstituteMenuPart {
    @Override
