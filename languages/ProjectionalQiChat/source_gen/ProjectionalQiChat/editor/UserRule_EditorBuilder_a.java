...
/*package*/ class UserRule_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_1() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_stapb6_b0");
    Style style = new StyleImpl();
    ...
    if (nodeCondition_stapb6_a7b0()) {
      editorCell.addEditorCell(createCollection_2());
    }
    return editorCell;
  }
  private boolean nodeCondition_stapb6_a7b0() {
    return ListSequence.fromList(SLinkOperations.getChildren(myNode, LINKS.subrules$kZhF)).isNotEmpty();
  }
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "UserRule:");
    editorCell.setCellId("Constant_stapb6_a1a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_stapb6_b1a");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new inputSingleRoleHandler_stapb6_c1a(myNode, LINKS.input$kRKG, getEditorContext());
    return provider.createCell();
  }
  private static class inputSingleRoleHandler_stapb6_c1a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public inputSingleRoleHandler_stapb6_c1a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_stapb6_d1a");
    Style style = new StyleImpl();
  ...
  private EditorCell createConstant_3() {
    ...
    editorCell.setCellId("Constant_stapb6_e1a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createRefNode_2() {
    SingleRoleCellProvider provider = new outputSingleRoleHandler_stapb6_f1a(myNode, LINKS.output$kSeI, getEditorContext());
    return provider.createCell();
  }
  private static class outputSingleRoleHandler_stapb6_f1a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public outputSingleRoleHandler_stapb6_f1a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
  ...
  private EditorCell createConstant_4() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
    editorCell.setCellId("Constant_stapb6_g1a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
    editorCell.getStyle().putAll(style);
    editorCell.addKeyMap(new new_firstOrderSubrule());
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createCollection_2() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_stapb6_h1a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
    editorCell.getStyle().putAll(style);
    if (nodeCondition_stapb6_a0h1a()) {
      editorCell.addEditorCell(createRefNodeList_0());
    }
    return editorCell;
  }
  private boolean nodeCondition_stapb6_a0h1a() {
    return ListSequence.fromList(SLinkOperations.getChildren(myNode, LINKS.subrules$kZhF)).isNotEmpty();
  }
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new subrulesListHandler_stapb6_a7b0(myNode, getEditorContext());
  ...
  private static class subrulesListHandler_stapb6_a7b0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public subrulesListHandler_stapb6_a7b0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(subrulesListHandler_stapb6_a7b0.this.getNode(), LINKS.subrules$kZhF));
      try {
    ...
    public EditorCell createSeparatorCell(SNode prevNode, SNode nextNode) {
      EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), getNode(), subrulesListHandler_stapb6_a7b0.this.getSeparatorText(prevNode, nextNode));
