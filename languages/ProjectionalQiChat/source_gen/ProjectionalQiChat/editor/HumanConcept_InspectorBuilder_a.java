...
/*package*/ class HumanConcept_InspectorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_xu9f4o_1");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new commentSingleRoleHandler_xu9f4o_c0(myNode, LINKS.comment$PK3S, getEditorContext());
    return provider.createCell();
  }
  private static class commentSingleRoleHandler_xu9f4o_c0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public commentSingleRoleHandler_xu9f4o_c0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new descriptionSingleRoleHandler_xu9f4o_d0(myNode, LINKS.description$MSuR, getEditorContext());
    return provider.createCell();
  }
  private static class descriptionSingleRoleHandler_xu9f4o_d0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public descriptionSingleRoleHandler_xu9f4o_d0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_xu9f4o_2");
    Style style = new StyleImpl();
  ...
  private EditorCell createConstant_3() {
    ...
    editorCell.setCellId("Constant_xu9f4o_3");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createRefNode_2() {
    SingleRoleCellProvider provider = new ruleSingleRoleHandler_xu9f4o_g0(myNode, LINKS.rule$l738, getEditorContext());
    return provider.createCell();
  }
  private static class ruleSingleRoleHandler_xu9f4o_g0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public ruleSingleRoleHandler_xu9f4o_g0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
  ...
  private EditorCell createConstant_4() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
    editorCell.setCellId("Constant_xu9f4o_4");
    Style style = new StyleImpl();
    new notEditableStyleClass(getEditorContext(), getNode()).apply(style, editorCell);
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createConstant_5() {
    ...
    editorCell.setCellId("Constant_xu9f4o_5");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createConstant_6() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
    editorCell.setCellId("Constant_xu9f4o_6");
    Style style = new StyleImpl();
    new notEditableStyleClass(getEditorContext(), getNode()).apply(style, editorCell);
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
  ...
  private EditorCell createConstant_7() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "Human Input which can be used like a variable inside of other human inputs.");
    editorCell.setCellId("Constant_xu9f4o_7");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createConstant_8() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "Just call this concept to expand another human input by this rules.");
    editorCell.setCellId("Constant_xu9f4o_8");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
