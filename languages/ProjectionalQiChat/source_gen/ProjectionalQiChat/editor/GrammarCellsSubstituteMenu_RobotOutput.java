...
public class GrammarCellsSubstituteMenu_RobotOutput extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_RobotOutput() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_di2yt3_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "RobotOutput", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_di2yt3_a extends GrammarCellsSubstituteMenuPart {
    @Override
