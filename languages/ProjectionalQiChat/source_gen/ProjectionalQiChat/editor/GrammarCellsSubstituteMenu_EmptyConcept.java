...
public class GrammarCellsSubstituteMenu_EmptyConcept extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EmptyConcept() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_zbx9kr_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EmptyConcept", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_zbx9kr_a extends GrammarCellsSubstituteMenuPart {
    @Override
