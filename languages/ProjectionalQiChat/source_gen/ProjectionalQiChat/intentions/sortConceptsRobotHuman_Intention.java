...
public final class sortConceptsRobotHuman_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  private Collection<IntentionExecutable> myCachedExecutable;

  public sortConceptsRobotHuman_Intention() {
    super(Kind.NORMAL, true, new SNodePointer("r:513aedb1-a87e-4f29-99a9-48208a62eca2(ProjectionalQiChat.intentions)", "6208480774280153355"));
  }

  @Override
  public String getPresentation() {
    return "sortConceptsRobotHuman";
  }
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public String getDescription(final SNode node, final EditorContext editorContext) {
      return "Sort Concepts RobotConcept -> HumanConcept";
    }
    ...
    private boolean isApplicableToNode(final SNode node, final EditorContext editorContext) {
      return ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(node, LINKS.header$Q5v0), LINKS.localConcepts$hTKt)).any(new IWhereFilter<SNode>() {
        public boolean accept(SNode it) {
          return SNodeOperations.isInstanceOf(it, CONCEPTS.RobotConcept$rd) && ListSequence.fromList(SNodeOperations.getPrevSiblings(it, false)).any(new IWhereFilter<SNode>() {
            public boolean accept(SNode it) {
              return SNodeOperations.isInstanceOf(it, CONCEPTS.HumanConcept$qf);
            }
          });
    ...
    public IntentionDescriptor getDescriptor() {
      return sortConceptsRobotHuman_Intention.this;
    }
