...
public final class convertToHumanConcept_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  private Collection<IntentionExecutable> myCachedExecutable;

  public convertToHumanConcept_Intention() {
    super(Kind.NORMAL, true, new SNodePointer("r:513aedb1-a87e-4f29-99a9-48208a62eca2(ProjectionalQiChat.intentions)", "6120172104210639231"));
  }

  @Override
  public String getPresentation() {
    return "convertToHumanConcept";
  }
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public String getDescription(final SNode node, final EditorContext editorContext) {
      return "Convert to Human Concept";
    }

    @Override
    public void execute(final SNode node, final EditorContext editorContext) {
      SNode newConcept = SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0x9f283760f9ca4f5bL, 0x8990d42851344ce7L, 0x6fd223061c49b106L, "ProjectionalQiChat.structure.HumanConcept"));
      ...
      ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(newConcept, LINKS.rule$l738), LINKS.inputs$iwW4)).addSequence(Sequence.fromIterable(SNodeOperations.ofConcept(SLinkOperations.getChildren(SLinkOperations.getTarget(node, LINKS.rule$l80a), LINKS.outputs$iAkW), CONCEPTS.IHumanInputConfirmed$rG)));
    ...
    public IntentionDescriptor getDescriptor() {
      return convertToHumanConcept_Intention.this;
    }
