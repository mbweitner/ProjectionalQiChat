...
public class SecondOrderSubrule_Constraints extends BaseConstraintsDescriptor {
  public SecondOrderSubrule_Constraints() {
    super(CONCEPTS.SecondOrderSubrule$ph);
  }
  ...
  private static boolean staticCanBeAChild(SNode node, SNode parentNode, SAbstractConcept childConcept, SContainmentLink link) {
    return SNodeOperations.isInstanceOf(parentNode, CONCEPTS.FirstOrderSubrule$oM);
  }
  private static final SNodePointer canBeChildBreakingPoint = new SNodePointer("r:0732640b-7693-4dcb-8a72-67b764f4b543(ProjectionalQiChat.constraints)", "3761955782232070531");
