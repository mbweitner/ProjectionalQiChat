...
public class change_names_Topic_QuickFix extends QuickFix_Runtime {
  public change_names_Topic_QuickFix() {
    super(new SNodePointer("r:2e52173d-a6ef-4c74-b7ba-dc1accb9a614(ProjectionalQiChat.typesystem)", "7237576769905748250"));
  }
  public String getDescription(SNode node) {
    return "rename concepts";
  }
  public void execute(SNode node) {
    List<SNode> humanConcepts = Sequence.fromIterable(SNodeOperations.ofConcept(SLinkOperations.getChildren(SLinkOperations.getTarget(((SNode) change_names_Topic_QuickFix.this.getField("topic")[0]), LINKS.header$Q5v0), LINKS.localConcepts$hTKt), CONCEPTS.HumanConcept$qf)).toListSequence();
    List<SNode> robotConcepts = Sequence.fromIterable(SNodeOperations.ofConcept(SLinkOperations.getChildren(SLinkOperations.getTarget(((SNode) change_names_Topic_QuickFix.this.getField("topic")[0]), LINKS.header$Q5v0), LINKS.localConcepts$hTKt), CONCEPTS.RobotConcept$rd)).toListSequence();
